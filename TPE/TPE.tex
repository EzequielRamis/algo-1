...
\pred{mismaFechaDeRelevamiento}{th: $eph_h$, ti:
	$eph_i$}{
	(|th|>0 \wedge |ti|>0) \implicaLuego
	(\bloque{+2em}{
		\paraTodo{h}{hogar}{
			h\in th \implica ( h[@hogA\tilde n o] =
			head(th)[@hogA\tilde n o] \wedge\\
			h[@hogTrimestre] = head(th)[@hogTrimestre]
			)
		} \wedge\\
		\paraTodo{i}{individuo}{
			i\in ti \implica ( i[@indA\tilde n o] =
			head(th)[@hogA\tilde n o] \wedge\\
...
\pred{atributosValidos}{th: $eph_h$, ti:
	$eph_i$}{
	\paraTodo{h}{hogar}{1800\leq h[@hogA \tilde n o] \wedge \\ 1\leq
		h[@hogTrimestre]\leq 4 \wedge \\ 1\leq
		h[@iv2] \wedge \\ 1\leq h[@ii2]}
	\wedge\\ \paraTodo {i}{individuo}{1\leq i[@componente] \wedge \\ 1800\leq
...
\begin{proc}{histHabitacional}{\In th: $eph_h$, \In ti: $eph_i$, \In region: \ent, \Out res: \TLista{\ent}}{}
	...
	\post{ |res| = \#deHabitaciones(h) \leftrightarrow
		esCasaConMasHabitacionesEnRegion(th, region, hogar) \yLuego
		\bloque{+6em}{
			(\forall{i: \ent})(0\leq i < |res| \implicaLuego res[i] =
			\#casaConNHabitaciones(th, i + 1)
			)}
	}
\end{proc}

\aux{\#deHabitaciones}{h:hogar}{\ent}{h[@iv2]}

\aux{\#casaConNHabitaciones}{th: $eph_h$, n: \ent}{\ent}{\sum_{h\in th}\IfThenElse{h[@iv1]=1 \wedge h[@iv2]=n}{1}{0}}

\pred{esCasaConMasHabitacionesEnRegion}{th: $eph_h$, r:
	\ent, h : hogar}{(\forall{i : hogar})(h[@iv2]\geq
	i[@iv2])
}
...
\aux{totalCasasPorRegion}{th: $eph_h$, r: \ent}{\ent}{
	\sum_{h\in th}\IfThenElse{h[@iv1]=1 \wedge h[@region] = r}{1}{0}
}

\aux{totalCasasCriticasPorRegion}{th: $eph_h$, ti: $eph_i$, r: \ent}{\ent}{
	\sum_{h\in th}\IfThenElse{esCasaCritica(h, ti) \wedge h[@region] = r}{1}{0}
}

\pred{esCasaCritica}{h: hogar, ti: $eph_i$}{
	h[@iv1]=1 \wedge esHacinamientoCritico(h, ti) \wedge h[@mas500] = 0
}

\pred{esHacinamientoCritico}{h: hogar, ti: $eph_i$}{
	\#personasEnHogar(h, ti) / h[@ii2] > 3
}

\aux{\#personasEnHogar}{h: hogar, ti: $eph_i$}{\ent}{
	\sum_{i\in ti} \IfThenElse{i[@indCodusu] = h[@hogCodusu]}{1}{0}
}
