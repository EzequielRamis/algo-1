...
\aux{\#personasTrabajandoADistanciaEnCiudadesGrandes}{th: $eph_h$, ti: $eph_i$}{\ent}{
	\bloque{+2em}{
		\sum_{i\in ti}\IfThenElse{viveEnDeptoOCasaEnCiudadGrande(i, th) \wedge trabajaADistancia(i)}{1}{0}
	}
}
...
\pred{viveEnDeptoOCasaEnCiudadGrande}{i: individuo, th: $eph_h$}{
	\existe{h}{hogar}{
		h\in th \wedge\\ personaEnHogar(i, h) \wedge h[@mas500] = 1 \wedge (h[@iv1] = 1 \vee h[@iv1] = 2)
	}
}
