...
\pred{encuestaValida}{th: $eph_h$, ti: $eph_i$}{
	...
	/*falta ver que si o si que ninguna region este vacia de hogares */
}
...
\begin{proc}{histHabitacional}{\In th: $eph_h$, \In ti: $eph_i$, \In region: \ent, \Out res: \TLista{\ent}}{}
	\pre{ encuestaValida(th, ti) \wedge 1\leq region\leq 6 /*falta ver que si o si que la region tenga al menos una casa*/}
...
\begin{proc}{laCasaEstaQuedandoChica}{\In th: $eph_h$, \In ti: $eph_i$, \Out res: \TLista{\float}}{}
	\pre{ encuestaValida(th, ti) \yLuego \neg(\exists{reg: \ent})(1\leq region\leq 6 \wedge regionVaciaDeCasas(th,reg)})
	\post{ |res| = 6 \yLuego
		\bloque{+6em}{
			\paraTodo{i}{\ent}{
...
\pred{regionVaciaDeCasas}{th: $eph_h$, r: \ent}{
	\#casasPorRegion(th, r) = 0
}
