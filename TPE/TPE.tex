...
/* Este auxiliar funciona sii $s$ tiene elementos únicos y
$e$ pertenece a la lista */\\
...
\begin{proc}{corregirRegion}{\Inout th: $eph_h$, \In ti: $eph_i$}{}
	...
	\implica (\bloque{+2em}{ th[i][@region]=5 \wedge\\ th[i][@hogCodusu]=TH[i][@hogCodusu] \wedge\\
		th[i][@hogA\tilde no]=TH[i][@hogA\tilde no] \wedge\\
		th[i][@hogTrimestre]=TH[i][@hogTrimestre] \wedge\\
		th[i][@hogLatitud]=TH[i][@hogLatitud] \wedge\\
		th[i][@hogLongitud]=TH[i][@hogLongitud] \wedge\\ th[i][@ii7]=TH[i][@ii7]
		\wedge\\ th[i][@mas500]=TH[i][@mas500] \wedge\\ th[i][iv1]=TH[i][iv1] \wedge\\
		th[i][@iv2]=TH[i][@iv2] \wedge\\ th[i][@ii2]=TH[i][@ii2] \wedge\\
