...
\begin{proc}{ordenarRegionYTipo}{\Inout th: $eph_h$, \Inout ti: $eph_i$}{}
	\pre{ encuestaValida(th, ti) \wedge th = TH_0 \wedge ti = TI_0 }
	\post{
		\bloque{+6em}{
			|th| = |TH_0| \wedge |ti| = |TI_0| \yLuego\\
			(\forall h: hogar)(h\in th \Iff h\in TH_0) \wedge\\
			(\forall i: individuo)(i\in ti \Iff i\in TI_0) \wedge\\
...
\begin{proc}{corregirRegion}{\Inout th: $eph_h$, \In ti: $eph_i$}{}
	\pre{ encuestaValida(th, ti) \wedge th = TH_0 }
	\post{ |th|=|TH_0| \yLuego (\forall i: \ent)(
		0\leq i < |th| \implicaLuego \bloque{+6em}{
			(TH_0[i][@region]=1 \implica 
				\bloque{+2em}{
					th[i][@region]=5 \wedge\\
					th[i][@hogCodusu]=TH_0[i][@hogCodusu] \wedge\\
					th[i][@hogA\tilde no]=TH_0[i][@hogA\tilde no] \wedge\\
					th[i][@hogTrimestre]=TH_0[i][@hogTrimestre] \wedge\\
					th[i][@hogLatitud]=TH_0[i][@hogLatitud] \wedge\\
					th[i][@hogLongitud]=TH_0[i][@hogLongitud] \wedge\\
					th[i][@ii7]=TH_0[i][@ii7] \wedge\\
					th[i][@mas500]=TH_0[i][@mas500] \wedge\\
					th[i][iv1]=TH_0[i][iv1] \wedge\\
					th[i][@iv2]=TH_0[i][@iv2] \wedge\\
					th[i][@ii2]=TH_0[i][@ii2] \wedge\\
					th[i][@ii3]=TH_0[i][@ii3]
				}
			)\wedge\\
			(TH_0[i][@region]\neq1 \implica th[i]=TH_0[i])
	}
	 ) }
\end{proc}
