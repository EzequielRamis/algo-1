		...
		\bloque{+6em}{
			\paraTodo{i}{\ent}{
				0 \leq i < |res| \implicaLuego ( \bloque{+2em}{
					0\leq res[i]\leq 1 \wedge\\ res[i] = \IfThenElse{regionVacia(th,i+1)}{0\\}{\bloque{+2em}{totalCasasCriticasPorRegion(th, ti, i + 1) / totalCasasPorRegion(th, i + 1)}}
				})
			}
		}
	}
...
\aux{regionVacia}{th: $eph_h$, r: \ent}{\ent}{
	totalCasasPorRegion(th, r) = 0
}
