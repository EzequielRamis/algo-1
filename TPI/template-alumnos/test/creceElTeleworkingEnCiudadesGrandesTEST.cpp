...
TEST(creceElTeleworkingEnCiudadesGrandesTEST, crece) {
    ...
    //                                                                   Ubicación
    //                                                                   v
    eph_i t1i = {{20957, 2018, 1, 1, 3, 1, 88, 0, 0, 90000, 1},  // NO
                 {20957, 2018, 2, 1, 3, 2, 82, 0, 0, 25000, 1},  // NO
                 {22866, 2018, 1, 0, 3, 1, 31, 1, 3, 59000, 1},  // NO
                 {22866, 2018, 2, 1, 3, 2, 28, 1, 3, 0, 6},      // Esta no: Hotel
                 {31117, 2018, 3, 0, 3, 2, 46, 1, 3, 17000, 1},  // NO
                 {31117, 2018, 4, 0, 3, 1, 20, 1, 3, 5000, 6},   // SI
                 {31117, 2018, 5, 0, 3, 2, 15, 0, 0, 5000, 1},   // NO
                 {22114, 2018, 1, 0, 3, 1, 18, 0, 0, 20000, 1}}; // NO
    ...
    eph_i t2i = {{20957, 2020, 1, 1, 3, 1, 88, 0, 0, 90000, 1},  // NO
                 {20957, 2020, 2, 1, 3, 2, 82, 0, 0, 25000, 1},  // NO
                 {22866, 2020, 1, 0, 3, 1, 31, 1, 3, 59000, 1},  // NO
                 {22866, 2020, 2, 1, 3, 2, 28, 1, 3, 0, 6},      // Esta no: Hotel
                 {31117, 2020, 3, 0, 3, 2, 46, 1, 3, 17000, 1},  // NO
                 {31117, 2020, 4, 0, 3, 1, 20, 1, 3, 5000, 6},   // SI
                 {31117, 2020, 5, 0, 3, 2, 15, 1, 0, 5000, 6},   // SI
                 {22114, 2020, 1, 0, 3, 1, 18, 0, 0, 20000, 1}}; // NO
...
TEST(creceElTeleworkingEnCiudadesGrandesTEST, nocrecePorqueNoTrabaja) {

    //                                                        +500  Tipo       Lugar para trabajar
    //                                                           v   v           v
    eph_h t1h = {{22114, 2018, 3, 319611, 629088, 3, 41, 1, 1, 3, 1, 2}}; // Esta no: menos 500

    //                                                                   Ubicación
    //                                                                   v
    eph_i t1i = {{22114, 2018, 1, 0, 3, 1, 18, 0, 0, 20000, 1}};

    //                                                        +500  Tipo       Lugar para trabajar
    //                                                           v   v           v
    eph_h t2h = {{22114, 2020, 3, 319611, 629088, 3, 41, 1, 1, 3, 1, 2}}; // Esta no: menos 500

    eph_i t2i = {{22114, 2020, 1, 0, 3, 1, 18, 0, 0, 20000, 1}};
